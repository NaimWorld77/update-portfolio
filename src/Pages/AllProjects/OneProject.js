...
import img1 from '../../images/luxaryGold/1.jpg';
import img2 from '../../images/luxaryGold/2.jpg';
import img3 from '../../images/luxaryGold/5.jpg';
        ...
        <div className=" bg-dark">
            <div className="row py-5 mx-2">
                ...
                <h1 className="text-white">Creative Agency</h1>
                    ...
                    <div>
                        <a href="https://luxary-gold.web.app/" target="_blank">
                        <button type="button" class="btn btn-danger me-2">
                        <i class="fab fa-chrome"></i> 
                            Live Site</button>
                        </a>
                        <a href="https://github.com/NaimWorld77/niche-product-client-site" target="_blank">
                        <button type="button" class="btn btn-danger me-2">
                        <i class="fab fa-github-square"></i> 
                            Code Link</button>
                        </a>
                        <a href="https://github.com/NaimWorld77/niche-product-server" target="_blank">
                        <button type="button" class="btn btn-danger me-2">
                        <i class="fab fa-github-square"></i> 
                            Server Link</button>
                        </a>
